[space.siy.waveformview](../../index.md) / [R](../index.md) / [style](index.md) / [Base_Widget_AppCompat_Light_ActionBar_Solid](./-base_-widget_-app-compat_-light_-action-bar_-solid.md)
